...
public class Main {
    public static void main(String args[]) {
        ...
        student.getDepartments(studentList);
        student.studentsEnrolledAfter2018(studentList);
        student.getMaleCSEStudents(studentList);
        student.numOfMalesAndFemales(studentList);
        student.avgOfMalesAndFemales(studentList);
        student.detailsOfHighestPercentageStudent(studentList);
        student.numOfStudentsInEachDept(studentList);
        student.avgPercentageInEachDept(studentList);
        student.detailsOfYoungestMaleInElectronics(studentList);
        student.numOfFemalesAndMalesInCSEDept(studentList);
